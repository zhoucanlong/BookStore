						...
						<div class="login_box">
							...
							<div class="form">
								<form action="UserServlet?method=login" method="post">
									<label style="color:#fff;font-size: 15px">用户名称：</label>
									<input class="itxt" type="text" placeholder="请输入用户名" autocomplete="off" 
										tabindex="1" name="username" id="username" value="<%=request.getParameter("username")==null?"":request.getParameter("username")%>"/>
									<br />
									<br />
									<label style="color:#fff;font-size: 15px">用户密码：</label>
